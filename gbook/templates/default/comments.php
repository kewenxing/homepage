...
<div class="gbook_commentbox">
	...
	<span class="gbook_submitted"><?php echo $lang['t15']; ?></span><br class="clear" />
	<span class="gbook_submitted_by"><?php echo $lang['t17']; ?> <b><?php echo $name; ?></b></span><br class="clear" />
	<?php
	if ($from)
	{
	...
	<span class="gbook_comments"><?php echo $lang['t16']; ?></span><br class="clear" />
